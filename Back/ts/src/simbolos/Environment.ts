...
export class Environment {
  ...
  public guardar_variable(nombre: string,line:number,column:number, valor: any, type: Type): boolean {
    if (!this.buscar_variable(nombre)) {
      this.tablaSimbolos.set(nombre, new simbolos(valor, nombre,type,line,column, 1, 0, 0,null,null));
      return true
    }
  ...
  public guardar_Funcion(nombre: string,line:number,column:number, type: Type,Ins:Array<Instruccion>,Param:Array<Declaracion>|null): boolean {
    if (!this.buscar_variable(nombre)) {
      this.tablaSimbolos.set(nombre, new simbolos(null, nombre,type,line,column, 1, 0, 0,Ins,Param));
      return true
    }
    console.log("esta variable [" + nombre + "] ya existe...");
    return false
  ...
  public guardar_Vector(nombre: string,line:number,column:number, valor: any, type: Type, dim1: Number): boolean {

    if (!this.buscar_variable(nombre)) {
      this.tablaSimbolos.set(nombre, new simbolos(valor, nombre, type,line,column, 2, dim1, 0,null,null));
      return true
    }
  ...
  public guardar_Matriz(nombre: string,line:number,column:number, valor: any, type: Type, dim1: any, dim2: any): boolean {

    if (!this.buscar_variable(nombre)) {
      this.tablaSimbolos.set(nombre, new simbolos(valor, nombre, type,line,column, 3, dim1, dim2,null,null));
      return true
    }
    console.log("esta variable [" + nombre + "] ya existe...");
    return false
